...
var _user$project$Cell$Cell = F3(
	function (a, b, c) {
		return {track_id: a, is_active: b, id: c};
	});

var _user$project$Cmds$playRawSound = _elm_lang$core$Native_Platform.outgoingPort(
	'playRawSound',
	function (v) {
		return v;
	});
...
var _user$project$Track$defaultTracks = function (total_cells) {
	return _elm_lang$core$Native_List.fromArray(
		[
			A4(
			...
			A2(
				_elm_lang$core$List$map,
				function (cell_id) {
					return A2(_user$project$Cell$init, cell_id, 1);
				},
				total_cells),
			'Kick',
			'/samples/kick.wav'),
			...
			A2(
				_elm_lang$core$List$map,
				function (cell_id) {
					return A2(_user$project$Cell$init, cell_id, 2);
				},
				total_cells),
			'Snare',
			'/samples/snare.wav'),
	...
	function (msg, model) {
		...
		switch (_p4.ctor) {
			...
			case 'SendUpdatedCell':
				var _p8 = _p4._0;
				var tracks = A2(_user$project$Main$toggleCells, model.tracks, _p8);
				var payload = _elm_lang$core$Json_Encode$object(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'track_id',
							_1: _elm_lang$core$Json_Encode$int(_p8.track_id)
						},
							{
							ctor: '_Tuple2',
							_0: 'is_active',
							_1: _elm_lang$core$Json_Encode$bool(_p8.is_active)
						},
							{
							ctor: '_Tuple2',
							_0: 'id',
							_1: _elm_lang$core$Json_Encode$int(_p8.id)
						}
						]));
				var push$ = A2(
			...
			case 'ReceiveMetronomeTick':
				var _p9 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Main$decodeMetronomeTick, _p4._0);
				if (_p9.ctor === 'Ok') {
